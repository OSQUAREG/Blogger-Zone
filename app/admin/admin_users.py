...
def update(id):
    ...
    return render_template("admin-update-user.html", title=f"Admin - Update {user.firstname}'s Profile", **context)
...
def view(id):
    ...
    return render_template("admin-user-dashboard.html", title=f"Admin - {user.firstname}'s Dashboard", **context)
